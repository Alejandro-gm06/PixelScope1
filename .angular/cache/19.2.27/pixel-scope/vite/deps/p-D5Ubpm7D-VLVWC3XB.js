...
var D = (o2, n, r, a, e2, s, d2 = false, c = 0, l3 = true) => __async(null, null, function* () {
  if (!r && !a) return;
  const f3 = ((o3, n2, t2, i3) => {
    ...
    return ((o4, n3, t3, i4) => {
      ...
      return {
        scrollAmount: u3,
        scrollDuration: Math.min(400, Math.max(150, f4 / 0.3)),
        scrollPadding: t3,
        inputSafeY: 4 - (r3 - s2)
      };
  ...
  if (u2(o2, n, true, f3.inputSafeY, d2), v(n), s && r && (h = f3.scrollPadding, y(r, h)), "undefined" != typeof window) {
    ...
    const e3 = () => __async(null, null, function* () {
      void 0 !== a2 && clearTimeout(a2), window.removeEventListener("ionKeyboardDidShow", d3), window.removeEventListener("ionKeyboardDidShow", e3), r && (yield f(r, 0, f3.scrollAmount, f3.scrollDuration)), u2(o2, n, false, f3.inputSafeY), document.activeElement === n && v(n), s && b(n, r, () => h = 0);
    }), d3 = () => {
...
var x = (t2, i3) => __async(null, null, function* () {
  if (void 0 === o) return;
  const l3 = "ios" === i3, f3 = "android" === i3, w2 = t2.getNumber("keyboardHeight", 290), m3 = t2.getBoolean("scrollAssist", true), y2 = t2.getBoolean("hideCaretOnScroll", l3), b2 = t2.getBoolean("inputBlurring", false), h2 = t2.getBoolean("scrollPadding", true), v2 = Array.from(o.querySelectorAll("ion-input, ion-textarea")), x2 = /* @__PURE__ */ new WeakMap(), K = /* @__PURE__ */ new WeakMap(), M = yield t.getResizeMode(), j = (n) => __async(null, null, function* () {
...
@ionic/core/components/p-D5Ubpm7D.js:
  (*!
   * (C) Ionic http://ionicframework.com - MIT License
   *)
*/
//# sourceMappingURL=p-D5Ubpm7D-VLVWC3XB.js.map
